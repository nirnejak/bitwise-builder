    ...
    <section className="container mb-48 px-5 xl:px-0">
      <div>
        <motion.h1
          ...
          className="mt-48 mb-6 text-center font-semibold text-6xl text-zinc-900 tracking-tighter md:text-8xl"
        >
          Our Services
        </motion.h1>
        <motion.p
          ...
          animate={"visible"}
          variants={variants}
          className="mb-24 text-center text-base text-zinc-600 tracking-tight md:text-lg"
        >
          What can we do for you?
        </motion.p>
        <div className="grid w-full grid-cols-2 gap-4 md:grid-cols-4 md:gap-8 md:px-24">
          <Link
          ...
          >
            ...
            >
              <span className="absolute top-3 right-3 rounded-full bg-zinc-900 p-2.5 text-zinc-50">
                <ArrowUpRight
                  size={17}
                  className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:scale-150 group-focus:translate-x-1 group-focus:-translate-y-1 group-focus:scale-150"
                />
              </span>
